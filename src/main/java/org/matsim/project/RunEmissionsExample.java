...
import org.matsim.vehicles.VehicleUtils;
     ...
     */
    public final class RunEmissionsExample{

        private final static String runDirectory = "./test/output/";
        private static final String configFile = "./scenarios/sampleScenario/testv2_Vehv2/config_average.xml";
        ...
        public static void main (String[] args){
            RunEmissionsExample emissionToolOfflineExampleV2 = new RunEmissionsExample();
